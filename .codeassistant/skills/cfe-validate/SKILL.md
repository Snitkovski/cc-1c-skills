...
```powershell
python ".codeassistant/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname"
python ".codeassistant/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname\Configuration.xml"
python ".codeassistant/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname" -ConfigPath "src\cf"
```
