...
```powershell
python ".gemini/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname"
python ".gemini/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname\Configuration.xml"
python ".gemini/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname" -ConfigPath "src\cf"
```
