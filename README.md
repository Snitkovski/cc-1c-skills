...
Автоматическая сборка из [main](https://github.com/Snitkovski/cc-1c-skills) — навыки 1С:Предприятие 8.3 для AI-агента **Yandex Code Assistant** с рантаймом **PowerShell**.
