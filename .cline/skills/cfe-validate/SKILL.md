...
```powershell
python ".cline/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname"
python ".cline/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname\Configuration.xml"
python ".cline/skills/cfe-validate/scripts/cfe-validate.py" -ExtensionPath "src\cfe\extname" -ConfigPath "src\cf"
```
